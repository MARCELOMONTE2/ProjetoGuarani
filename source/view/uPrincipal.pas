...
uses
  ...
  uCadCliente, uCadProduto, udmvendas, uPedidos,uGeraRelatorio;
...
procedure TfrmPrincipal.CategoryButtons1Categories0Items3Click(Sender: TObject);
begin
  if frmGeraRelatorio = nil then
    frmGeraRelatorio := TfrmGeraRelatorio.Create(self);

  frmGeraRelatorio.Show;
...
begin
  ...
  Except
    on E: Exception do
      ShowMessage('Erro ao tentar conectar com o banco: ' + E.Message );
